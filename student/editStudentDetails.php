	...
	<div class="box-content">	
		<h4>Edit Student Details</h4><br/>
		<a class="btn btn-success" href="javascript:void(0);" onclick="listStudentMasters();">
					<i class="icon-arrow-left icon-white"></i> Back                                            
		</a><br/>	
	  <?php if($userDetails !=null && count($userDetails) > 0){ 	?>
		<form class="form-horizontal" id="editStudentFrm" name="editStudentFrm" onsubmit="return false;">
		    <fieldset>
		        ...
		        <div class="control-group">
		         ...
		         <div class="control-group">
                       ...
                       <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text" style="width: 250px;" maxlength="40" class="required" readonly="readonly"
		                         value="<?php echo $userDetails[0]['sem_name'] ?>"/>
                                  </div>
                       </div>
