...
?> 
              ...
              <table class="table table-striped table-bordered" style="width: 50%;">
                       <?php   for($i=0; $i <count($lst); $i++){  ?>
                            ...
                            <tr>    
                                <td class="center"><div style="float: left"><b><?php $arr= getUserDetailsByMasterId($lst[$i]['sm_id']); 
                                echo "Student";                                            
                                ?> Says :</b>
                           ...
                           <?php } else{ ?>
                              <tr>
                                  <td class="center"><div style="float: right"><b>
                                     <?php $arr= getUserDetailsByMasterId($lst[$i]['fb_by']);  echo $arr['name']; ?> Says :</b>
                                       <?php echo $lst[$i]['msg'] ?> </div></td>
                              </tr> 
                       <?php }
                        }
                  ...
                  <tr>
                   ...
                   <tr>
                    <td>
                        <button type="button" class="btn btn-primary" onclick="addMoreMessage('<?php echo $fb_id;?>');" > 
                                Send
                         </button>
                    </td>          
                 </tr> 
