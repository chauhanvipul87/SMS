	<?php
        ...
        if(!empty($md_id)){
			...
			$userDetails= getAdminUserListByStatus(USERTYPE_ADMIN,$filterArray);
	?>		
	<div class="box-content">	
		<h4>Edit Admin Users</h4><br/>
		<a class="btn btn-success" href="javascript:void(0);" onclick="listAdminUsers();">
					<i class="icon-arrow-left icon-white"></i> Back                                            
		</a><br/>	
	  <?php if($userDetails !=null && count($userDetails) > 0){ 	?>
		<form class="form-horizontal" id="editAdminUserFrm" name="editAdminUserFrm" onsubmit="return false;">
		    <fieldset>
