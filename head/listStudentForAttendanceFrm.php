<?php
	...
	$head_id      = $_SESSION['sessionUserId'];
        ...
        if(!empty($head_id) && !empty($schedule_id)){
            ...
            $scheduleList= getAllScheduleDetails($head_id,$filterScheduleArray);
...
?>
        ...
        <button type="button" class="btn btn-primary" onclick="setPresentForAllSelected('<?php echo $schedule_id ?>');" > 
                       Set Present For Selected Record
        </button>
        <button type="button" class="btn btn-primary" onclick="setAbsentForAllSelected('<?php echo $schedule_id ?>');" > 
                       Set Absent For Selected Record
        </button>
        <button type="button" class="btn btn-primary" onclick="sendForApprovalToAdmin('<?php echo $schedule_id ?>');" > 
                       Send For Approval
        </button>
